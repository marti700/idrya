...
class SpellChecker{
  ...
  def generateMispelings(dic:Map[String,String]):Map[String,List[String]] = {
...
//val r = new SpellChecker()
//val posMisspelings = r.generateMispelings(r.dic)
//val input = "faree"
//val suggestions = r.getSuggestions(posMisspelings,r.dic,input)
//println(suggestions)
